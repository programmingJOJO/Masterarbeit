...
;(function($) {
      ...
      $(Obj).delegate('a.trigger', ev, function(ev) {
          ...
          function action(obj) {
             if (($nextEl).length && $thislink.data('state') && (o.collapsible)) {
                  ...
                  $nextEl.filter(':visible')[o.hideMethod](o.hideSpeed, function() {$thislink.data('state', 0);if(o.autoHeightCallBack){autoHeight(o.autoHeightCallBack)}});
              }
              if (($nextEl.length && !$thislink.data('state')) || (!($nextEl).length && $thislink.closest(o.wrapper).not('.shown'))) {
                  ...
                  $nextEl.filter(':hidden')[o.showMethod](o.showSpeed, function() {$thislink.data('state', 1);if(o.autoHeightCallBack){autoHeight(o.autoHeightCallBack)}});
              }
          ...
          if (o.event == 'click') {
              if(o.autoHeightCallBack){$(o.autoHeightCallBack).css('height', 'auto');}
              action($trigger); 
              if ($thislink.is('[href $= "#"]')) {
                  return false;
              } else {
  ...
  $.fn.accordion.defaults = {
    ...
    retFunc: null, //
    autoHeightCallBack: null // custom param for equal heights boxes (ie9)
  };
